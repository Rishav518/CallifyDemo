...
const Contact = () => {
  return (
    <>
    <Header/>
    <div className="flex justify-center font-Poppins py-20 px-6">
        <div className="flex flex-col justify-center">
            <div className="flex flex-col  max-w-7xl justify-center items-center w-full ">
                ...
                <div className='w-full md:w-[80%] flex flex-col md:flex-row items-center justify-center'>
                    <div className='w-full px-6 md:w-[70%] bg-[#f1f5f8] rounded-tl-3xl flex items-start justify-center py-4'>
                    ...
                    <div className='w-full md:h-96 md:w-[30%] bg-[#0025d1] rounded-br-3xl p-4 text-white'>
                        ...
                        <ion-icon class="text-2xl text-cyan-400 hover:text-gray-300 cursor-pointer" name="logo-facebook"></ion-icon>
                        <ion-icon class="text-2xl text-pink-500 hover:text-gray-300 cursor-pointer" name="logo-instagram"></ion-icon>
                        <ion-icon class="text-2xl text-yellow-400 hover:text-gray-300 cursor-pointer" name="logo-linkedin"></ion-icon>
                        <ion-icon class="text-2xl text-green-400 hover:text-gray-300 cursor-pointer" name="logo-twitter"></ion-icon>
                        </div>
